...
%% added booktabs and tikzpackage 8/22/19
...
\textbf{\large{Statistical Methods Exam \myDate \hfill Exam ID \myID}}
...
%% Add extra page for scratch paper
\newpage
\begin{center} \LARGE \textbf{Scratch Paper} \end{center}
\newpage
\begin{center} \LARGE \textbf{Scratch Paper} \end{center}
\end{document}
